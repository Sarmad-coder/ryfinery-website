...
export class UserMenuComponent implements OnInit {
  ...
  menu: Menu[] = [
    { label: 'View Profile', icon: 'user-01', shortcut: 'view-profile-shortcut', routerLink: '/profile' },
    { label: 'Settings', icon: 'settings-01', shortcut: 'settings-shortcut', routerLink: '/settings' },
    { line: true },
